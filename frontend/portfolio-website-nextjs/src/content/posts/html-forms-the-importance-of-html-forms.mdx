---
title: 'HTML Forms'
subheading: 'The Importance of Proper HTML Form Semantics for User Experience and Accessibility'
excerpt: 'HTML forms are an essential part of many websites, allowing users to submit data, request information, or take other actions. However, the way in which forms are coded can have a significant impact on the user experience and accessibility of a website.'
status: 'published'
...
## Some free resources
- <Link href="https://developer.mozilla.org/en-US/docs/Learn/Forms/Form_validation" label="mdn.org - Client-side form validation" isInternal={false}/>
- <Link href="https://web.dev/learn/forms/" label="web.dev - Forms" isInternal={false}/>
- <Link href="https://www.w3schools.com/js/js_validation.asp" label="W3Schools - JavaScript Forms" isInternal={false}/>