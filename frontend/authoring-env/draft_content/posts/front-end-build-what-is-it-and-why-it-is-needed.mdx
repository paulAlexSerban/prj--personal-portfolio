...
## Some Resources
- [Making Sense of the Front-end Build Tools](https://www.FreeCodeCamp.org/news/making-sense-of-front-end-build-tools-3a1b3a87043b/)
...
- [FE Build Tools you can use in your development lifecycle](https://www.smashcreate.com/our-insights/4-best-build-tools-you-can-use-in-frontend-development/)
- [SmashingMagazine - The Future of Frontend Tools](https://www.smashingmagazine.com/2022/06/future-frontend-build-tools/)