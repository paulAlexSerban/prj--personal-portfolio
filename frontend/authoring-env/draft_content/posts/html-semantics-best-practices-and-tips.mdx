...
- <Link href="https://web.dev/learn/html/semantic-html/" label="web.dev - Semantic HTML"/>
- <Link href="https://www.w3schools.com/html/html5_semantic_elements.asp" label="w3schools - HTML5 Semantic Elements"/>
- <Link href="https://www.codecademy.com/learn/learn-html/modules/learn-semantic-html/cheatsheet" label="CodeCademy - Semantic HTML"/>
- <Link href="https://www.semrush.com/blog/semantic-html5-guide/" label="Semrush - Semantic HTML Guide"/>
- <Link href="https://ilikekillnerds.com/2014/07/how-to-correctly-use-semantic-html5-article-main-and-section-tags/" label="I Like Kill Nerds - How To Correctly Use Semantic HTML5 &lt;article&gt;, &lt;main&gt; and &lt;section&gt; tags"/>
- <Link href="https://www.thoughtco.com/why-use-semantic-html-3468271" label="Thoughtco - Why Use Semantic HTML"/>
- <Link href="https://hackernoon.com/how-to-write-semantic-html-dkq3ulo" label="hackernoon.com - How to Write Semantic HTML"/>
- <Link href="https://www.FreeCodeCamp.org/news/html-best-practices/" label="FreeCodeCamp.org/blog - HTML Best Practices – How to Build a Better HTML-Based Website"/>
- <Link href="https://blog.hubspot.com/website/semantic-html" label="hubspot.org/blog - Semantic HTML: What It Is and How It Improves Your Site"/>
