...
- <Link label="alistapart.com.com - Responsive Web Design" href="https://alistapart.com/article/responsive-web-design/" isInternal={false}/>
- <Link label="learn.microsoft.com - HTML5 - Responsive Web Design" href="https://learn.microsoft.com/en-us/archive/msdn-magazine/2011/november/html5-responsive-web-design" isInternal={false}/>
- <Link label="smashingmagazine.com - Responsive Web Design Techniques, Tools and Design Strategies" href="https://www.smashingmagazine.com/2011/07/responsive-web-design-techniques-tools-and-design-strategies/" isInternal={false}/>
- <Link label="web.dev - Learn Responsive Design" href="https://web.dev/learn/design/" isInternal={false}/>
- <Link label="webfx.com/blog - A Brief Look at Grid-Based Layouts in Web Design" href="https://www.webfx.com/blog/web-design/a-brief-look-at-grid-based-layouts-in-web-design/" isInternal={false}/>
- <Link label="kinsta.con/blog - The Beginner’s Guide to Responsive Web Design (Code Samples & Layout Examples)" href="https://kinsta.com/blog/responsive-web-design/" isInternal={false}/>
- <Link label="webflow.com/blog - The Guide To Responsive Web Design" href="https://webflow.com/" isInternal={false}/>
- <Link label="webdesign.tutsplus.com - Responsive Web Design: What It Is and How to Use It" href="https://webdesign.tutsplus.com/articles/responsive-web-design-what-it-is-and-how-to-use-it--webdesign-10041" isInternal={false}/>
- <Link label="youtube.com/freeCodeCamp - Introduction To Responsive Web Design - HTML & CSS" href="https://www.youtube.com/watch?v=9cKsq14Kfsw" isInternal={false}/>
