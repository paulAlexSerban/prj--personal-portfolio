  ...
  return (
    <div id={ID} className={base}>
      ...
      <Main>
        ...
        />
        {pageContent.main.section_1.children.portfolioOverview.projects.length > 0 && (
          <Section
          ...
          >
            <PortfolioOverview content={pageContent.main.section_1.children.portfolioOverview} />
          </Section>
        )}

        {pageContent.main.section_2.children.portfolioOverview.projects.length > 0 && (
          <Section
          ...
          >
            <PortfolioOverview content={pageContent.main.section_2.children.portfolioOverview} />
          </Section>
        )}
        ...
        {pageContent.main.section_3.children.postsOverview.list.length > 0 && (
          ...
          >
            <PostsOverview
              blogList={pageContent.main.section_3.children.postsOverview.list}
              parentPage={pageContent.main.section_3.children.postsOverview.parent_page}
              category={pageContent.main.section_3.children.postsOverview.category}
            />
          </Section>
        )}
        ...
        {pageContent.main.section_4.children.postsOverview.list.length > 0 && (
          ...
          >
            <PostsOverview
              blogList={pageContent.main.section_4.children.postsOverview.list}
              parentPage={pageContent.main.section_4.children.postsOverview.parent_page}
              category={pageContent.main.section_4.children.postsOverview.category}
            />
          </Section>
        )}
        ...
        {pageContent.main.section_5.children.postsOverview.list.length > 0 && (
          ...
          >
            <PostsOverview
              blogList={pageContent.main.section_5.children.postsOverview.list}
              parentPage={pageContent.main.section_5.children.postsOverview.parent_page}
              category={pageContent.main.section_5.children.postsOverview.category}
            />
          </Section>
        )}
      </Main>
